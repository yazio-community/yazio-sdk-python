...
T = TypeVar("T", bound="MealSummaryTipsRequest")


@_attrs_define
class MealSummaryTipsRequest:
    """
    Attributes:
    ...
    experiments: list[Any] | Unset = UNSET
    requested_at: float | Unset = UNSET
    date: str | Unset = UNSET
    mealtime: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if mealtime is not UNSET:
            field_dict["mealtime"] = mealtime
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        experiments = cast(list[Any], d.pop("experiments", UNSET))

        requested_at = d.pop("requested_at", UNSET)

        date = d.pop("date", UNSET)

        mealtime = d.pop("mealtime", UNSET)

        language = d.pop("language", UNSET)

        meal_summary_tips_request = cls(
        ...
        meal_summary_tips_request.additional_properties = d
        return meal_summary_tips_request
