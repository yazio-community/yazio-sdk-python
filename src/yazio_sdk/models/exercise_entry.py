...
if TYPE_CHECKING:
    from ..models.exercise_entry_activity_item import ExerciseEntryActivityItem


T = TypeVar("T", bound="ExerciseEntry")
...
class ExerciseEntry:
    """
    Attributes:
        activity (list[ExerciseEntryActivityItem] | Unset):
    """

    activity: list[ExerciseEntryActivityItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _activity is not UNSET:
            ...
            for activity_item_data in _activity:
                activity_item = ExerciseEntryActivityItem.from_dict(activity_item_data)
        ...
        exercise_entry.additional_properties = d
